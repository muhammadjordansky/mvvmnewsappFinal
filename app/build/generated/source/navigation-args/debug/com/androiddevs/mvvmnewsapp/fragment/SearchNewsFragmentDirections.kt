...
class SearchNewsFragmentDirections private constructor() {
  private data class ActionSearchNewsFragmentToArticleFragment(
    ...
    override fun getActionId(): Int = R.id.action_searchNewsFragment_to_articleFragment
  ...
  companion object {
    fun actionSearchNewsFragmentToArticleFragment(article: Article): NavDirections =
